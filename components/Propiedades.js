...
const properties = [
  {
    title: "Propiedad uno",
    description:
      "Conocemos el mercado y tenemos un historial de éxito en la compra, venta y alquiler de propiedades.",
  ...
  },
  {
    ...
    description:
      "Tenemos relaciones sólidas con desarrolladores, propietarios y otros agentes inmobiliarios.",
    image: "/feature-1.jpeg",
  },
];
  ...
  return (
    <section className="py-16 bg-gray-50 relative">
      ...
      <div className="container mx-auto px-4 relative z-10">
        <h2 className="text-4xl font-bold text-center mb-12">COMPRAR</h2>
